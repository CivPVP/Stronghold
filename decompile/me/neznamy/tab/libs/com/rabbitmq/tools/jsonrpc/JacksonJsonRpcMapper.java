...
public class JacksonJsonRpcMapper implements JsonRpcMapper {
               ...
               if (token == JsonToken.FIELD_NAME) {
                  ...
                  if ("result".equals(name)) {
                     ...
                     if (expectedReturnType == void.class) {
                        ...
                        result = this.convert(parser.readValueAsTree(), expectedReturnType);
                     }
                  } else if ("error".equals(name)) {
                     errorMap = (Map<String, Object>)this.convert(parser.readValueAsTree(), Map.class);
   ...
   protected Object convert(TreeNode node, Class<?> expectedType) throws IOException {
      ...
      if (expectedType.isPrimitive()) {
         ...
         value = this.mapper.readValue(node.traverse(), expectedType);
      }
