...
import me.neznamy.tab.libs.org.yaml.snakeyaml.comments.CommentType;
...
import me.neznamy.tab.libs.org.yaml.snakeyaml.events.AliasEvent;
import me.neznamy.tab.libs.org.yaml.snakeyaml.events.CommentEvent;
import me.neznamy.tab.libs.org.yaml.snakeyaml.events.DocumentEndEvent;
import me.neznamy.tab.libs.org.yaml.snakeyaml.events.DocumentStartEvent;
import me.neznamy.tab.libs.org.yaml.snakeyaml.events.Event;
import me.neznamy.tab.libs.org.yaml.snakeyaml.events.ImplicitTuple;
import me.neznamy.tab.libs.org.yaml.snakeyaml.events.MappingEndEvent;
import me.neznamy.tab.libs.org.yaml.snakeyaml.events.MappingStartEvent;
import me.neznamy.tab.libs.org.yaml.snakeyaml.events.ScalarEvent;
import me.neznamy.tab.libs.org.yaml.snakeyaml.events.SequenceEndEvent;
import me.neznamy.tab.libs.org.yaml.snakeyaml.events.SequenceStartEvent;
import me.neznamy.tab.libs.org.yaml.snakeyaml.events.StreamEndEvent;
import me.neznamy.tab.libs.org.yaml.snakeyaml.events.StreamStartEvent;
import me.neznamy.tab.libs.org.yaml.snakeyaml.reader.StreamReader;
import me.neznamy.tab.libs.org.yaml.snakeyaml.scanner.Scanner;
import me.neznamy.tab.libs.org.yaml.snakeyaml.scanner.ScannerImpl;
import me.neznamy.tab.libs.org.yaml.snakeyaml.tokens.AliasToken;
import me.neznamy.tab.libs.org.yaml.snakeyaml.tokens.AnchorToken;
import me.neznamy.tab.libs.org.yaml.snakeyaml.tokens.BlockEntryToken;
import me.neznamy.tab.libs.org.yaml.snakeyaml.tokens.CommentToken;
import me.neznamy.tab.libs.org.yaml.snakeyaml.tokens.DirectiveToken;
import me.neznamy.tab.libs.org.yaml.snakeyaml.tokens.ScalarToken;
import me.neznamy.tab.libs.org.yaml.snakeyaml.tokens.StreamEndToken;
import me.neznamy.tab.libs.org.yaml.snakeyaml.tokens.StreamStartToken;
import me.neznamy.tab.libs.org.yaml.snakeyaml.tokens.TagToken;
import me.neznamy.tab.libs.org.yaml.snakeyaml.tokens.TagTuple;
import me.neznamy.tab.libs.org.yaml.snakeyaml.tokens.Token;
import me.neznamy.tab.libs.org.yaml.snakeyaml.util.ArrayStack;
         ...
         if (!ParserImpl.this.scanner.checkToken(Token.ID.FlowSequenceEnd)) {
            if (!this.first) {
               if (!ParserImpl.this.scanner.checkToken(Token.ID.FlowEntry)) {
                  Token token = ParserImpl.this.scanner.peekToken();
                  throw new ParserException(
                     "while parsing a flow sequence", ParserImpl.this.marks.pop(), "expected ',' or ']', but got " + token.getTokenId(), token.getStartMark()
                  );
               }
