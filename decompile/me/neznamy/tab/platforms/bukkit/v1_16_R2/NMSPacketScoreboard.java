...
public class NMSPacketScoreboard extends SafeScoreboard<BukkitTabPlayer> {
   ...
   public void setScore(@NonNull SafeScoreboard.Score score) {
      ...
      this.sendPacket(new PacketPlayOutScoreboardScore(Action.CHANGE, score.getObjective().getName(), score.getHolder(), score.getValue()));
   }
   ...
   public void removeScore(@NonNull SafeScoreboard.Score score) {
      ...
      this.sendPacket(new PacketPlayOutScoreboardScore(Action.REMOVE, score.getObjective().getName(), score.getHolder(), score.getValue()));
   }
