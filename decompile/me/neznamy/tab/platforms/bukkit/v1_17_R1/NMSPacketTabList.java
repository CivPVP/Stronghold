   ...
   public Object onPacketSend(@NonNull Object packet) {
      try {
         ...
         for (PlayerInfoData nmsData : info.b()) {
            ...
            updatedList.add(rewriteEntry ? new PlayerInfoData(profile, latency, EnumGamemode.getById(gameMode), displayName) : nmsData);
         }
      ...
      try {
         ...
         PLAYERS.set(
            ...
            Collections.singletonList(
               new PlayerInfoData(
                  this.createProfile(id, name, skin), latency, EnumGamemode.getById(gameMode), displayName == null ? null : displayName.convert()
               )
            )
         );
