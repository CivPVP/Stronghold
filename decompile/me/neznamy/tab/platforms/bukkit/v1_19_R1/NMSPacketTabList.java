...
import net.minecraft.world.entity.player.ProfilePublicKey.a;
   ...
   public Object onPacketSend(@NonNull Object packet) {
      try {
         ...
         for (PlayerInfoData nmsData : info.b()) {
            ...
            updatedList.add(rewriteEntry ? new PlayerInfoData(profile, latency, EnumGamemode.a(gameMode), displayName, publicKey) : nmsData);
         }
      ...
      try {
         ...
         PLAYERS.set(
            ...
            Collections.singletonList(
               new PlayerInfoData(
                  this.createProfile(id, name, skin), latency, EnumGamemode.a(gameMode), displayName == null ? null : displayName.convert(), null
               )
            )
         );
