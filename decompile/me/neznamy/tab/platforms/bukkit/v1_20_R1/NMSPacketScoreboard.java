   ...
   public Object onPacketSend(@NonNull Object packet) {
      try {
         ...
         if (packet instanceof PacketPlayOutScoreboardDisplayObjective) {
            TAB.getInstance()
               .getFeatureManager()
               .onDisplayObjective(this.player, ((PacketPlayOutScoreboardDisplayObjective)packet).a(), ((PacketPlayOutScoreboardDisplayObjective)packet).c());
         }

         if (packet instanceof PacketPlayOutScoreboardObjective) {
            TAB.getInstance()
               .getFeatureManager()
               .onObjective(this.player, ((PacketPlayOutScoreboardObjective)packet).d(), ((PacketPlayOutScoreboardObjective)packet).a());
         }
