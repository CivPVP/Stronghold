package me.neznamy.tab.platforms.bukkit.v1_21_R2;
...
public class NMSPacketTabList extends TrackedTabList<BukkitTabPlayer> {
   ...
   public void updateDisplayName0(@NonNull UUID entry, @Nullable TabComponent displayName) {
      ...
      this.sendPacket(UPDATE_DISPLAY_NAME_SET, entry, "", null, false, 0, 0, displayName, 0);
   }
   ...
   public void updateLatency(@NonNull UUID entry, int latency) {
      ...
      this.sendPacket(UPDATE_LATENCY_SET, entry, "", null, false, latency, 0, null, 0);
   }
   ...
   public void updateGameMode(@NonNull UUID entry, int gameMode) {
      ...
      this.sendPacket(UPDATE_GAME_MODE_SET, entry, "", null, false, 0, gameMode, null, 0);
   }
   ...
   public void updateListed(@NonNull UUID entry, boolean listed) {
      ...
      this.sendPacket(UPDATE_LISTED_SET, entry, "", null, listed, 0, 0, null, 0);
   }
   ...
   public void updateListOrder(@NonNull UUID entry, int listOrder) {
      ...
      this.sendPacket(UPDATE_LIST_ORDER_SET, entry, "", null, false, 0, 0, null, listOrder);
   }
      ...
      try {
         ...
         if (packet instanceof ClientboundPlayerInfoUpdatePacket info) {
            ...
            for (b nmsData : info.e()) {
               ...
               updatedList.add(
                  rewriteEntry ? new b(profileId, nmsData.b(), nmsData.c(), latency, EnumGamemode.a(gameMode), displayName, nmsData.g(), nmsData.h()) : nmsData
               );
            }
