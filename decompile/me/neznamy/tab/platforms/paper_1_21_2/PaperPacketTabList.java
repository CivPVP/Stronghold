...
public class PaperPacketTabList extends TrackedTabList<BukkitTabPlayer> {
   ...
   public void updateDisplayName0(@NonNull UUID entry, @Nullable TabComponent displayName) {
      ...
      this.sendPacket(updateDisplayName, entry, "", null, false, 0, 0, displayName, 0);
   }
   ...
   public void updateLatency(@NonNull UUID entry, int latency) {
      ...
      this.sendPacket(updateLatency, entry, "", null, false, latency, 0, null, 0);
   }
   ...
   public void updateGameMode(@NonNull UUID entry, int gameMode) {
      ...
      this.sendPacket(updateGameMode, entry, "", null, false, 0, gameMode, null, 0);
   }
   ...
   public void updateListed(@NonNull UUID entry, boolean listed) {
      ...
      this.sendPacket(updateListed, entry, "", null, listed, 0, 0, null, 0);
   }
   ...
   public void updateListOrder(@NonNull UUID entry, int listOrder) {
      ...
      this.sendPacket(updateListOrder, entry, "", null, false, 0, 0, null, listOrder);
   }
