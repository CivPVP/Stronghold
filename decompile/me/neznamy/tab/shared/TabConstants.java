...
public class TabConstants {
   ...
   public static final String PROXY_CHANNEL_NAME = "TAB-2";
   public static final String PIPELINE_HANDLER_NAME = "TAB";
   ...
   public static final int MAX_LOG_SIZE = 16777216;
