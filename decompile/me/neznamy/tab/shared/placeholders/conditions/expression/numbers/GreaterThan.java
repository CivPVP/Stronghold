...
public class GreaterThan extends NumericExpression {
   public GreaterThan(@NotNull String[] sides) {
   ...
   public ConditionalExpression invert() {
      return new LessThanOrEqual(new String[]{this.leftSide, this.rightSide});
   }
