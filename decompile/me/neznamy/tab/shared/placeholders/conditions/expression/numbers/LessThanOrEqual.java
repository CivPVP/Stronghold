...
public class LessThanOrEqual extends NumericExpression {
   public LessThanOrEqual(@NotNull String[] sides) {
   ...
   public ConditionalExpression invert() {
      return new GreaterThan(new String[]{this.leftSide, this.rightSide});
   }
