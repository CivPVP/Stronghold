...
public class StartsWith extends ComparatorExpression {
   public StartsWith(@NotNull String[] sides) {
   ...
   public ConditionalExpression invert() {
      return new NotStartsWith(new String[]{this.leftSide, this.rightSide});
   }
